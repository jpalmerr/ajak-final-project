...
def test_set_limit_generates_single_limited_list():
    '#set_limit takes array of arrays and number n, returns single array with n items from each array'
...
def test_generate_labels_returns_array():
    '#generate_label takes no. of classes and no. of samples and returns array from 0 to no. of classes multiplied by no. of samples'
